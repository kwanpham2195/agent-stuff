---
name: librarian
description: "Cache and refresh remote Git repositories for local source reference. Use when the user provides a GitHub, GitLab, Bitbucket, SSH, or owner/repo reference, or when upstream source is needed for analysis."
---
