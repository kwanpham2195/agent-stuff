...
Also apply [`EFFECT_SERVICES.md`](EFFECT_SERVICES.md) for service and Layer ownership, [`BOUNDARIES_AND_PARSING.md`](BOUNDARIES_AND_PARSING.md) for lifetimes, and [`DESIGNING_MODULES.md`](DESIGNING_MODULES.md) for composition-root boundaries.
