...
This reference covers Effect `Config` recipes, providers, and config-backed Layers. For configuration ownership, startup failure handling, and resource lifecycle, also apply [`BOUNDARIES_AND_PARSING.md`](BOUNDARIES_AND_PARSING.md).
...
For tests that supply configuration, follow [`EFFECT_TESTING.md#configuration`](EFFECT_TESTING.md#configuration).
