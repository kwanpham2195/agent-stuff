...
Optional reference for examples of voice, sentence editing, and code presentation. Read only the sections relevant to the current writing problem. The examples and historical guidance below are retained for comparison. [Technical-writing](../technical-writing/SKILL.md) and [unslop](../unslop/SKILL.md) are the authoritative standards when guidance differs; examples do not override their rules.

## Core identity

**Expert-to-reader guidance**: We write as a knowledgeable colleague explaining a system they helped build. We're confident, practical, and focused on helping readers understand the subject and take the next useful step.

The overall feeling is: _"Here's how this works, here's exactly what you need to know, and here's a concrete example to prove it."_
...
**Use the product, system, or tool name consistently when describing what it does:**
